    ...
    return (
        <div className="header flex md:flex-row justify-between items-center p-4">
            ...
            {location.pathname === `/proyecto/readmi/${id}` ? (
                 <button className='dark:text-dark-color8 dark:hover:border-dark-color10 border-2 border-transparent dark:bg-dark-color1 dark:hover:shadow-hover-dark dark:hover:border-2 hover:bg-color9 hover:rounded-xl p-4 text-color8 no-underline text-3xl mr-8'>
                 <Link to='/proyectos'>
                     Volver
                 </Link>
             </button>
