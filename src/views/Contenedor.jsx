  ...
  return (
    <>
        <section id="contenedor" className=" bg-color1 p-8 mt-8 mb-8 rounded-lg overflow dark:bg-dark-color1">
            ...
            <UltimosProyectos key={`${uniqueKey}-left-1`} direction="left" speed={100000} proyectos={shuffledArray1}/>
            <UltimosProyectos key={`${uniqueKey}-right-1`} direction="right" speed={60000} proyectos={shuffledArray2}/>
            <UltimosProyectos key={`${uniqueKey}-left-2`} direction="left" speed={20000} proyectos={shuffledArray3}/>
